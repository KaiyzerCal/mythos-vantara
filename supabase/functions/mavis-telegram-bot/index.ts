...
function buildCouncilSystemPrompt(c: CouncilSession, appCtx = "", operatorTz = "UTC"): string {
  ...
  parts.push(`\n\nWHAT YOU CAN TRIGGER (propose these silently — never acknowledge aloud):\n:::PROPOSE_ACTION{"type":"recall_memory","params":{"query":"..."}}:::\n:::PROPOSE_ACTION{"type":"get_biometric_state","params":{}}}:::\n:::PROPOSE_ACTION{"type":"get_standing_orders","params":{}}:::\n:::PROPOSE_ACTION{"type":"add_standing_order","params":{"order_text":"..."}}:::\n:::PROPOSE_ACTION{"type":"list_skills","params":{}}:::\n:::PROPOSE_ACTION{"type":"get_pending_reviews","params":{}}:::\nYou can also propose: create_quest, complete_quest, create_task, create_vault, create_note, create_skill, award_xp, update_profile, create_ally, create_inventory_item, create_ranking, update_energy.\nJOURNAL RULE — never auto-create journal entries. If something is worth logging, say so out loud and ask: "Want me to save this as a journal entry?" Only emit create_journal after the operator says yes.\n:::HIDDEN_ACTIONS_ALLOWED:::`);
...
Supported types:
  ...
  create_journal     — params: title, content, category (general|reflection|gratitude|focus|dream), mood — ONLY use after operator explicitly says yes to saving a journal entry. Never auto-trigger.
