...
import { EMBEDDABLE_TABLES } from "../_shared/embeddableTables.ts";
...
// Table -> embedded-column config, shared with reembedRow.ts so both write-time and backfill paths read the same mapping.
const TABLES = EMBEDDABLE_TABLES;
