...
// dropped — when that text later gets fed back into a persona/chat prompt
// as "recalled memory," the model faithfully quotes the mid-word fragment
// as if it were a complete sentence. Cut at the last word boundary instead
// and mark the cut with an ellipsis so a reader (human or model) can tell.
