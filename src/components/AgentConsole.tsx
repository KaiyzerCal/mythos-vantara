  ...
  return (
    ...
    >
      ...
      {expanded && step.output && (
        <div className="mt-2 pt-2 border-t border-zinc-700/50 text-zinc-300 prose dark:prose-invert prose-xs max-w-none">
              ...
              <div className="flex-1 overflow-y-auto p-3 space-y-3">
                ...
                {agentMessages.map(msg => (
                  <div key={msg.id} className="text-xs">
                    ...
                    {msg.content ? (
                      <div className="prose dark:prose-invert prose-xs max-w-none leading-relaxed text-zinc-200">
