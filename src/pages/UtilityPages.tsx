...
export function AuthPage() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      // Same root cause as a cold-network resume elsewhere in the app:
      // right after Android/Capacitor brings the WebView back from a long
      // background suspend, the OS network stack can still be catching up,
      // so the very first request thrown at it fails with a plain "Failed
      // to fetch" that has nothing to do with the entered credentials.
