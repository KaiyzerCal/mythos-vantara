  ...
  return (
    <AppDataProvider>
      ...
      <div className="h-screen flex overflow-hidden bg-background">
        ...
        <main className={`flex-1 min-w-0 h-full ${["/mavis", "/mavis-ui", "/demo", "/factory", "/world-monitor", "/voice-lab", "/prompt-vault", "/agency", "/notebook", "/code-studio"].includes(location.pathname) ? "overflow-hidden" : "overflow-y-auto p-5"}`}>
          <Suspense fallback={Spinner}>
            <Routes>
